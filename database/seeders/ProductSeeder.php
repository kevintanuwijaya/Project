...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $picture = ['Bravia8K.jpg', 'TUFF15.jpg', 'ROGStrixG17.png', 'Iphone13Pro.jpg', 'OnePlus9.png', 'pixel5.jpg', 'samsung8K55TV.jpg', 'S21.jpg', 'ROGStrixSCARG15.png', 'samsung8K65TV.jpg'];
        $length = count($name);
        for($i=0; $i<$length; $i++){
            Product::create([
